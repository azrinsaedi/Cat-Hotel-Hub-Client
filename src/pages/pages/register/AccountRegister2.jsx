...
export const action = async ({ request }) => {
  ...
  try {
    await customFetch.post("/account/register", data);
...
export default function AccountRegister2() {
  return (
    <>
              ...
              <div className="col-xl-6 col-lg-7 col-md-9">
                <div className="text-center mb-60 md:mb-30">
                  ...
                  <div className="mt-5">
                    ...
                    <Link to="/account/login" className="text-accent-1">
                      Log In!
                    </Link>
                  </div>
                </div>
                ...
                <Form
                  ...
                  method="post"
                >
                  <FormRow2 type="text" name="username" labelText="Username" />
                  <FormRow2
                    type="text"
                    name="name"
                    labelText="Name"
